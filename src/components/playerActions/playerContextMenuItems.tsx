...
type MenuTranslateFn = (key: string, options?: Record<string, string | number>) => string;

export type ScoutMenuState = "ready" | "busy" | "already-assigned" | "unavailable";
...
export function buildViewProfileMenuItem(t: MenuTranslateFn, onClick: () => void): ContextMenuItem {
  return {
...
export function buildViewTeamMenuItem(t: MenuTranslateFn, onClick: () => void): ContextMenuItem {
  return {
...
export function buildToggleTransferListMenuItem(
  ...
  return {
    label: transferListed ? t("squad.removeFromTransferList") : t("squad.addToTransferList"),
...
export function buildToggleLoanListMenuItem(
  ...
  return {
    label: loanListed ? t("squad.removeFromLoanList") : t("squad.addToLoanList"),
