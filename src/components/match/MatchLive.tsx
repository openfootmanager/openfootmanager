...
import {
  ...
  Target, Flag, SlidersHorizontal, X
} from "lucide-react";
...
export default function MatchLive({
  ...
  // Shared between the static desktop aside and the mobile slide-over drawer.
  ...
  return (
    <MatchScreenLayout
      headerClassName="bg-linear-to-r from-gray-200 via-white to-gray-200 dark:from-navy-800 dark:via-navy-900 dark:to-navy-800 pt-safe"
    ...
    >
      ...
      {/* Main Content */}
      <div className="flex-1 flex overflow-hidden pb-safe">
          ...
          >
            <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-navy-700">
              ...
              <button
                ...
                aria-label={t('common.close')}
                onClick={() => setControlsOpen(false)}
                className="rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-navy-700"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
