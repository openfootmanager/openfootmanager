...
export default function DashboardSidebar({
  ...
  return (
    <aside
      className={`bg-navy-800 dark:bg-navy-800 border-r border-navy-700 text-white hidden md:flex h-screen sticky top-0 shrink-0 flex-col transition-[width] duration-200 ${collapsed ? "w-20" : "w-64"
        }`}
    >
      {/* Brand */}
      <div
