...
- **Linux com uma placa gráfica NVIDIA** — se a janela ficar em branco ou o jogo fechar ao arrancar, executa-o com `OFM_GPU_PROFILE=safe`. Normalmente o jogo deteta isto sozinho e recupera no arranque seguinte. Vê [Gráficos em Linux](LINUX_GRAPHICS.md)
