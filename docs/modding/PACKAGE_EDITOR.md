...
**Potential stays visible in both modes.** A ceiling says how far a player can go, which is a separate question from how their current ability was written down.
