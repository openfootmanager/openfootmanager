...
- **Linux con una scheda grafica NVIDIA** — se la finestra resta bianca o il gioco si chiude all'avvio, avvialo con `OFM_GPU_PROFILE=safe`. Di norma il gioco se ne accorge da solo e si ripristina al lancio successivo. Vedi [Grafica su Linux](LINUX_GRAPHICS.md)
