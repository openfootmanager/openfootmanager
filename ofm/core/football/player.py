...
class Player:
    ...
    def get_from_dict(cls, player_dict: dict):
        return cls(
            ...
            player_dict["first_name"].encode("utf-8").decode("unicode_escape"),
            player_dict["last_name"].encode("utf-8").decode("unicode_escape"),
            player_dict["short_name"].encode("utf-8").decode("unicode_escape"),
