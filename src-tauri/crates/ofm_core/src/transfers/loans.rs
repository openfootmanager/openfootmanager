//! The loan path: offering, countering, responding to, validating and pricing
//! loans; exercising loan buy-options (user + AI); and the loan development /
//! return machinery. Byte-faithful extraction from the original transfers.rs;
//! the seven public entry points stay resolvable as `ofm_core::transfers::*`.
...
pub(crate) fn has_open_loan_offer_from_club(
    player: &domain::player::Player,
    club_id: &str,
) -> bool {
    player
