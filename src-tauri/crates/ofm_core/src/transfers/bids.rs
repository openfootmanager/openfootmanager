//! Permanent transfers: bidding out, answering bids in, and the counter-offer rounds.
//!
//! Both directions share the negotiation machinery — the ceilings, the round counter and the
//! feedback the manager reads — so they sit together rather than being split by who started
//! the conversation.
