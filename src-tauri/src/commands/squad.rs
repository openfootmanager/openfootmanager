...
mod tests {
    ...
    fn assign_jersey_number_internal_assigns_and_persists() {
        ...
        let response =
            assign_jersey_number_internal(&state, "player-1", Some(10)).expect("response");
    ...
    fn assign_jersey_number_internal_allows_reassign_same_number_to_same_player() {
        ...
        let response =
            assign_jersey_number_internal(&state, "player-1", Some(7)).expect("response");
    ...
    fn set_team_kit_pattern_internal_updates_and_persists() {
        ...
        let response =
            set_team_kit_pattern_internal(&state, KitPattern::Stripes).expect("response");
